Enter IP addresses you want to reverse DNS lookup in ip.txt, one IP address per line.

Run ip-reverse-dns-lookup.pl from perl by entering 
	> perl ip-reverse-dns-lookup.pl 
